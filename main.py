...
serpapi_tool = Tool(
    ...
    description="A tool for searching the internet for up-to-date information. Always use this tool for questions that require real-time data or information not contained in the provided data. The input should be a search query string.",
...
# यहां टूल लिस्ट में SerpAPI को जोड़ा गया है
tools = [scrape_url_to_dataframe, serpapi_tool]
...
# यहां एजेंट को अपडेटेड टूल लिस्ट दी गई है
agent = create_tool_calling_agent(
    llm=llm,
    tools=tools,
    prompt=prompt
)
# यहां AgentExecutor को अपडेटेड टूल लिस्ट दी गई है
    ...
    try:
        ...
        if dataset_uploaded:
            llm_rules = (
                ...
                "2) DO NOT call scrape_url_to_dataframe() or fetch any external data. DO NOT call serp_api_search().\n"
            ...
            llm_rules = (
                "Rules:\n"
                "1) If you need web data, CALL scrape_url_to_dataframe(url) or serp_api_search(query).\n"
